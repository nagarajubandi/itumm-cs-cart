...
function gallery_show_video (video_image, show_player_controls, object, show_title_and_actions) {
    if (typeof(object) == 'undefined') {
        object = 'block';
    }
    $('#youtube_galary_' + object).attr('src', 'https://www.youtube-nocookie.com/embed/' + video_image + '?rel=0&amp;controls=' + show_player_controls + '&amp;showinfo=' + show_title_and_actions);
    $('.video-gallery-' + object).show();
