(function(_, $) {
    ...
    $.ceEvent('on', 'ce.change_select_list', function(object, elm) {
        if (elm.hasClass('cm-object-product-add')) {
            if (object.image_url) {
                object.context = '<table class="table-select2"><tr><td class="table-select2-column-image"><img src="' + object.image_url + '" alt="' + object.text + '" /></td>' + '<td class="truncate-product-name table-select2-column-name">' + object.text + '</td><td class="table-select2-column-product-code">' + object.code + '</td><td class="table-select2-column-price">' + object.price + '</td></tr></table>';
            } else {
                object.context = '<table class="table-select2"><tr><td class="no-image table-select2-no-images"><i class="glyph-image"></i></td>' + '<td class="truncate-product-name table-select2-column-name">' + object.text + '</td><td class="table-select2-column-product-code">' + object.code + '</td><td class="table-select2-column-price">' + object.price + '</td></tr></table>';
            }
        ...
        if (elm.hasClass('cm-object-customer-add')) {
            object.context = '<table class="table-select2-customer"><tr><td class="table-select2-column-firstname-lastname">' + object.text + '</td></tr><tr><td class="table-select2-column-email">' + object.email + '</td></tr><tr><td class="table-select2-column-phone">' + object.phone + '</td></tr></table>';
        }
    });
