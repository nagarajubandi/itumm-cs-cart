    ...
    (function($){
        var methods = {
            ...
            reload: function() {
                // disable animation
                var d = $(this),
                    delay = d.dialog('option', 'show');

                d.dialog('option', {show: 0, hide: 0, delayFocusTabbable: delay});
                ...
                // enable animation
                d.dialog('option', {show: 150, hide: 150, delayFocusTabbable: null});
            },
    ...
    (function($) {
        ...
        function _closeNotification(notification)
        {
            ...
            notification.fadeOut('fast', function() {
                if($.trim(notification.find('h1').text()) == 'The product was added to your Wish list'){
                    window.location.reload();
                } else {
                    notification.remove();
                }
        ...
        var methods = {
            show: function (data, key)
            {
                ...
                if (data.type == 'I') {
                    ...
                    var notification = $('<div class="cm-notification-content cm-notification-content-extended notification-content-extended cm-auto-hide ' + (data.message_state == "I" ? ' ' : '') + '" data-ca-notification-key="' + key + '">' +
