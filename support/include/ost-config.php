...
define('SECRET_SALT','Ey5tI_IInZAaywzqcNWGB8IpQW7PI8X8');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','kirans@inducosolutions.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','itummqa-db.ckyv9jz8srx5.us-east-1.rds.amazonaws.com');
define('DBNAME','itumm_support');
define('DBUSER','iTummQA_DB');
define('DBPASS','itummqa123');
