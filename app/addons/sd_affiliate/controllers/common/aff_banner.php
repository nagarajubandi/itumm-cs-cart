...
if ($mode == 'view') {
    ...
    if ($type != 'iframe_content' && $type != 'js') {
        ...
        echo '<div id="id_example_banner"><script data-no-defer type="text/javascript" language="javascript">' . $_banner_html . '</script><!--id_example_banner--></div>';
    }
}
