...
$schema['hw_modern_backend'] = array (
    'permissions' => array ('GET' => 'view_modern_backend', 'POST' => 'manage_modern_backend')
);
$schema['tools']['modes']['update_status']['param_permissions']['table']['hwmb'] = 'manage_modern_backend';
$schema['tools']['modes']['update_position']['param_permissions']['table']['hwmb'] = 'manage_modern_backend';
