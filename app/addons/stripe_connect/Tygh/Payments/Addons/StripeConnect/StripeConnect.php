...
class StripeConnect
{
    ...
    public function charge(array $order_info)
    {
        ...
        try {
            ...
            foreach ($orders_queue as $order_id => $company_id) {
                ...
                $payouts_manager->createWithdrawal($charge->metadata['commission'], $order_id);
    ...
    protected function chargeOrder(array $order, SourceInterface $payment_source, PayoutsManager $payouts_manager)
    {
        ...
        $amount = $this->formatAmount($order['total'], $order['secondary_currency']);
        list($commission, $fee) = $this->getApplicationFee($order, $order['secondary_currency'], $payouts_manager);
     ...
     */
    protected function formatAmount($amount, $currency_from)
    {
     ...
     */
    protected function getApplicationFee(array $order_info, $currency_from, PayoutsManager $payouts_manager)
    {
        ...
        $fee_in_cents = $this->formatAmount($commission, $currency_from);
    ...
    public function refund(array $order_info, $amount)
    {
        $params = array(
            ...
            'amount'           => $this->formatAmount($amount, $order_info['secondary_currency']),
