...
class Settings
{
    ...
    private function _processSettingData($setting, $lang_code)
    {
        ...
        if ($this->isVendorValuesSupportedByEditionType($setting['edition_type'])) {
    ...
    /*
     * Checks whether setting edition supports vendor values
     *
    ...
    public function isVendorValuesSupportedByEditionType($edition_type)
    {
        ...
        $result = fn_allowed_for('ULTIMATE') && !$this->_getCompanyId() && (in_array('ULT:VENDOR', $edition_type) || in_array('VENDOR', $edition_type));
