...
class ProductVariable implements IVariable, IActiveVariable
{
    ...
    public function __construct(ItemContext $context, array $config, Core $view, Formatter $formatter)
    {
        ...
        $this->original_price = $this->original_price - ($this->raw['tax']/$this->amount);
        //$this->subtotal = $this->subtotal - $this->raw['tax'];
        //$this->display_subtotal = $this->subtotal - $this->raw['tax'];
        ...
        $this->tax_cgst = $this->formatter->asPrice($this->raw['tax']/2, $this->currency_code, true, true);
        $this->tax_sgst = $this->formatter->asPrice($this->raw['tax']/2, $this->currency_code, true, true);
    }
    ...
    public static function attributes()
    {
        return array(
            ...
            'discount', 'company_id', 'base_price', 'original_price', 'cart_id', 'tax', 'tax_cgst', 'tax_sgst', 'subtotal', 'display_subtotal',
