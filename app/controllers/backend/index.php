...
if ($mode == 'index') {
    ...
    /* Nags Code for Sales, Current Balance & Last Payment */
    ...
    /* End of Nags Code for Sales, Current Balance & Last Payment */
    ...
    Tygh::$app['view']->assign('dashboard_stats', $dashboard_stats);
