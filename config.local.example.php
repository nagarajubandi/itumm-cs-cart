 ...
 */
$config['db_host'] = 'itumm.csd6kzokfycb.us-east-2.rds.amazonaws.com';
$config['db_name'] = 'itumm_live_pro';
$config['db_user'] = 'itumm';
$config['db_password'] = 'b7bE4XA2EAk3ABrF';
...
$config['http_host'] = 'itumm.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'itumm.com';
$config['https_path'] = '';
...
$config['admin_index']    = 'itumm_hq.php';
