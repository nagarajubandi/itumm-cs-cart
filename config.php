...
define('PRODUCT_VERSION', '4.7.1.SP3');
...
$config['resources'] = array(
    ...
    'admin_protection_url' => 'http://docs.cs-cart.com/4.7.x/install/security.html#step-1-rename-admin-php',
    'widget_mode_url' => 'http://docs.cs-cart.com/4.7.x/user_guide/look_and_feel/layouts/widget_mode/index.html',
    ...
    'kb_https_failed_url' => 'http://docs.cs-cart.com/4.7.x/install/possible_issues/secure_connection_failed.html',
    ...
    'docs_guideline' => 'http://docs.cs-cart.com/4.7.x/developer_guide/getting_started/guidelines.html'
);
