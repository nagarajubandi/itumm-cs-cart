...
<tr>
    ...
    <tr>
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            {assign var="order_tax_total" value=0}
            ...
            {hook name="orders:items_list_row"}
                ...
                <tr>
                    ...
                    <td style="padding: 5px 10px; background-color: #ffffff; text-align: right; font-size: 12px; font-family: Arial;">{if $oi.extra.exclude_from_calculate}{__("free")}{else}{include file="common/price.tpl" value=$oi.original_price-($oi.tax_value/$oi.amount)}{/if}</td>
                    {if $order_info.use_discount}
                    ...
                    {assign var="order_tax_total" value=$order_tax_total+$oi.tax_value}
                {/if}
            {/hook}
            {/foreach}
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;">{include file="common/price.tpl" value=$order_info.display_subtotal-$order_tax_total}</td>
                </tr>
                ...
                {foreach from=$order_info.taxes item=tax_data}
                    {if $tax_data.tax_subtotal > 0 }
                        <tr>
                            <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;">CGST&nbsp;({include file="common/modifier.tpl" mod_value=$tax_data.rate_value/2 mod_type=$tax_data.rate_type}{if $tax_data.price_includes_tax == "Y" && ($settings.Appearance.cart_prices_w_taxes != "Y" || $settings.General.tax_calculation == "subtotal")}&nbsp;{__("included")}{/if}):&nbsp;</td>
                            <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;">{include file="common/price.tpl" value=$tax_data.tax_subtotal/2}</td>
                        </tr>
                        <tr>
                            <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;">SGST&nbsp;({include file="common/modifier.tpl" mod_value=$tax_data.rate_value/2 mod_type=$tax_data.rate_type}{if $tax_data.price_includes_tax == "Y" && ($settings.Appearance.cart_prices_w_taxes != "Y" || $settings.General.tax_calculation == "subtotal")}&nbsp;{__("included")}{/if}):&nbsp;</td>
                            <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;">{include file="common/price.tpl" value=$tax_data.tax_subtotal/2}</td>
                        </tr>
                    {/if}
                {/foreach}
