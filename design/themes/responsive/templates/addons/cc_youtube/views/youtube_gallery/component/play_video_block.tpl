...
<div class="ty-product-bigpicture">
    ...
    {if $product}
        ...
        {assign var="redirect_url" value='youtube_gallery.view'}
            ...
            <div class="ty-product-bigpicture__left-wrapper">
                ...
                {if !$no_images}
                    <div class="ty-product-bigpicture__img  cm-reload-{$product.product_id} ty-product-bigpicture__as-thumbs" >
                        <iframe width="640" height="360"  src="https://www.youtube-nocookie.com/embed/{$product.youtube_link}?rel=0&amp;{if $addons.cc_youtube.show_player_controls == 'N'}controls=0{/if}{if $addons.cc_youtube.show_title_and_actions == 'N'}&amp;showinfo=0{/if}" frameborder="0" allowfullscreen></iframe>
