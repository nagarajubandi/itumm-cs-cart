...
<div id="product_video_play">
    {if $play_video_product_data}
        {include file="addons/cc_youtube/views/youtube_gallery/component/play_video_block.tpl" product=$play_video_product_data show_sku=true show_rating=true show_old_price=true show_price=true show_list_discount=true show_clean_price=true details_page=true show_discount_label=true show_product_amount=true show_product_options=true hide_form=$smarty.capture.val_hide_form 	min_qty=true
	show_edp=true
...
<div id="youtube_gallery_products_{$block.block_id}">
