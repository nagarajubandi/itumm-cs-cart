...
{capture name="main_icon"}
    <a id="video_gallery_element" {if $video_gallery}href="{"youtube_gallery.view&product_id=`$product.product_id`"|fn_url}"|fn_url}"{else}href="{"$product_detail_view_url"|fn_url}"{/if}>
