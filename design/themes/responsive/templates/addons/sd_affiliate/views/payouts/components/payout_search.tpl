...
<div class="control-group ty-control-group">
    <label class="control-group__title ty-control-group__title">{__("status")}:</label>
...
<div class="control-group ty-control-group">
    <label class="control-group__title ty-control-group__title">{__("amount")} ({$currencies.$primary_currency.symbol nofilter}):</label>
