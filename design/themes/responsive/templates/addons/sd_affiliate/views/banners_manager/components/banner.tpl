...
{if $banner_data.new_window}
            NewWindow: '{$banner_data.new_window}',
{/if}
...
{/if}
            OutlineColor: '{$affiliate_opts_settings.out_line_color}',
...
{/if}
<script data-no-defer id="id_script_banner_{$banner_data.banner_id}" type="text/javascript" src="{$html_content nofilter}">
</script>
    {/if}
