...
{capture name="banner_content"}
    {if $banner_type == "iframe_content" || $banner_type == "js_content"}
        ...
        {elseif $banner_data.type == "P"}
            ...
            <tr>
                <td align="{$banner_data.align}" style="padding: 5px 10px;">
            ...
            <tr>
                <td align="{$banner_data.align}" class="strong" style="padding: 5px 10px;">
    ...
    {elseif $banner_type == "iframe"}
        ...
        <iframe src="{$smarty.capture._href|fn_url nofilter}" scrolling="No" {if $banner_data.width}width="{$banner_data.width}"{/if} {if $banner_data.height}height="{$banner_data.height}"{/if} frameborder="0" {$banner_data.border}> </iframe>
    {elseif $banner_type == "js"}
        ...
        {else}
            {"aff_banner.view?bid=`$banner_data.banner_id`&type=js_content&sl=`$smarty.const.CART_LANGUAGE`&product_ids=`$banner_data.product_ids`&aff_id=$partner_id"|fn_url nofilter}
        {/if}
    {/if}
{/capture}
{/strip}
