...
<div class="ty-control-group" style="float:left;padding: 5px 0px 0px 0px;">
    ...
    <div class="ty-rma-search__status">
        {include file="common/status.tpl" status=$smarty.request.request_status display="select" name="request_status" status_type=$smarty.const.STATUSES_RETURN}
    </div>
...
<div id="s_show_options"{if !($smarty.request.order_status || $smarty.request.order_id)} class="rma-options hidden"{/if}>
    ...
    <div class="ty-control-group">
        ...
        <div class="ty-rma-search__status">
            {include file="common/status.tpl" status=$smarty.request.order_status display="select" name="order_status"}
        </div>
    </div>
</div>
