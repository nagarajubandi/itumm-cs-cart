...
{if $message.type == "I"}
    ...
    <div class="cm-notification-content cm-notification-content-extended notification-content-extended cm-auto-hide" data-ca-notification-key="{$key}">
...
{else}
    <div class="cm-notification-content notification-content cm-auto-hide {if $message.type == "N"}alert-success{elseif $message.type == "W"}alert-warning{else}alert-error{/if}" data-ca-notification-key="{$key}">
