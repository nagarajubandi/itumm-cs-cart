    ...
    <div id="apply_for_vendor_account" >
        ...
        <form action="{"companies.apply_for_vendor"|fn_url}" method="post" name="apply_for_vendor_form">
           ...
           {* {hook name="vendors:apply_description"}
			...
			<div class="ty-control-group">
                <label for="company_description_password" class="ty-control-group__title cm-required cm-email cm-trim">{__("password")}</label>
                <input type="password" name="company_data[password]" id="company_description_email" size="32" value="{$company_data.password}" class="ty-input-text" />
            </div>
