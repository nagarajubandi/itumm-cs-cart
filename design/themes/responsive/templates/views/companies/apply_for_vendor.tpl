    ...
    <div id="apply_for_vendor_account" >
        ...
        <form action="{"companies.apply_for_vendor"|fn_url}" method="post" name="apply_for_vendor_form">
           ...
           {* {hook name="vendors:apply_description"}
			...
			<div class="ty-control-group">
                <label for="company_description_password" class="ty-control-group__title cm-required  cm-password cm-trim">{__("password")}</label>
            ...
            <div class="ty-control-group">
                <label class="ty-control-group__title cm-required" for="company_description_pan_no">PAN No</label>
                <input type="text" name="company_data[pan_no]" id="company_description_pan_no" size="32" value="{$company_data.pan_no}" class="ty-input-text" />
            </div>

            <div class="ty-control-group">
                <label class="ty-control-group__title cm-required" for="company_description_gst_reg_no">GST Registration No</label>
                <input type="text" name="company_data[gst_reg_no]" id="company_description_gst_reg_no" size="32" value="{$company_data.gst_reg_no}" class="ty-input-text" />
            </div>
*}
