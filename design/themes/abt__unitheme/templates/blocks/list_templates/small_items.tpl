        ...
        {$smarty.capture.$form_open nofilter}
            ...
            <div class="ty-template-small__item-description">
                ...
                {assign var="name" value="name_$obj_id"}<bdi>{$smarty.capture.$name nofilter}</bdi>
				 <div class="ty-template-small__item-price"><span class="ty-price" id="line_discounted_price_326"><bdi><span class="ty-price-num">₹</span><span  class="ty-price-num">{$product.price|number_format:2}</span></bdi></span></div>
                {if $show_price}
