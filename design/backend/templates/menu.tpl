...
<div class="navbar-admin-top">
    ...
    <div class="navbar navbar-inverse" id="header_navbar">
        ...
        {if "MULTIVENDOR"|fn_allowed_for && !$runtime.simple_ultimate}
            <ul class="nav">
                <li class="nav-company">
                    <a href="{""|fn_url|escape}"  class="brand" >
					...
					{if $runtime.company_id}
					 <a href="{""|fn_url}" class="brand" style="text-transform: none !important;">{"iTumm Sellerhub"}</a>
					{else}
                ...
                {if $auth.company_id}
                    <li class="dropdown" >
                        <a href="{"companies.update?company_id=`$runtime.company_id`"|fn_url}" style="text-transform: none !important;"> {$runtime.company_data.company}</a>
                    </li>
                {else}
