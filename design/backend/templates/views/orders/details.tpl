    ...
    <div class="row-fluid">
        <div class="span8">
            ...
            <tr>
                ...
                <td class="nowrap">
                    {if $oi.extra.exclude_from_calculate}{__("free")}{else}{include file="common/price.tpl" value=$oi.original_price-($oi.tax_value/$oi.amount)}{/if}</td>
                <td class="center">
                    &nbsp;{$oi.amount}<br />
            ...
            <table class="pull-right">
                ...
                <tr>
                    <td>{__("subtotal")}:</td>
                    <td data-ct-totals="subtotal">{include file="common/price.tpl" value=$order_info.display_subtotal-$order_tax_total}</td>
                </tr>
                ...
                {if $order_info.taxes}
                    ...
                    {*{foreach from=$order_info.taxes item="tax_data"}
                        {if $tax_data.tax_subtotal > 0 }*}
                            <tr>
                                <td>&nbsp;CGST&nbsp;</td>
                                <td data-ct-totals="taxes-CGST">{include file="common/price.tpl" value=$order_tax_total/2}</td>
                            </tr>
                            <tr>
                                <td>&nbsp;SGST&nbsp;</td>
                                <td data-ct-totals="taxes-SGST">{include file="common/price.tpl" value=$order_tax_total/2}</td>
                            </tr>
                       {* {/if}
                    {/foreach}*}
                {/if}
