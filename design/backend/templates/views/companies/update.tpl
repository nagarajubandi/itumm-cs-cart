...
<div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" name="company_data[pan_no]" id="elm_company_pan_no" size="10" maxlength="10" value="{$company_data.pan_no}"  />
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="input-large" name="company_data[gst_reg_no]" id="elm_company_gst_reg_no" size="15" maxlength="15" value="{$company_data.gst_reg_no}"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_account_no">Bank Account No:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_account_no]" id="elm_company_bank_account_no" size="32" value="{$company_data.bank_account_no}"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_name">Bank Name:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_name]" id="elm_company_bank_name" size="32" value="{$company_data.bank_name}"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_ifsc_code">IFSC Code:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_ifsc_code]" id="elm_company_bank_ifsc_code" size="32" value="{$company_data.bank_ifsc_code}"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_account_holder_name">Account Holder Name:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_account_holder_name]" id="elm_company_bank_account_holder_name" size="32" value="{$company_data.bank_account_holder_name}"  />
        </div>
    </div>
{/hook}
