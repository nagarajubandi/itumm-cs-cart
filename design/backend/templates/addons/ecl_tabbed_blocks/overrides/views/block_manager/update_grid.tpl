...
<div class="cm-tabs-content">
    ...
    <div class="control-group cm-no-hide-input">
        <label class="control-label" for="elm_grid_is_tabbed_{$id}">{__("tabbed_blocks")}</label>
        <div class="controls">
            <input type="hidden" class="cm-no-hide-input" name="is_tabbed" value="N" />
            <input id="elm_grid_is_tabbed_{$id}" type="checkbox" class="cm-no-hide-input" name="is_tabbed" value="Y" {if $grid.is_tabbed == 'Y'}checked="checked"{/if} />
        </div>
    </div>
</div>
