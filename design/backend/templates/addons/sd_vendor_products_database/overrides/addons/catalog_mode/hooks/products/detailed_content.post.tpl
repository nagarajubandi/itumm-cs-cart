...
{if $runtime.company_id && $product_data.vendors[$runtime.company_id]}
    ...
    <div id="catalog_mode_product" class="in collapse">
        <fieldset>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="buy_now_url" name="product_data[buy_now_url]" value="{$product_data.vendors[$runtime.company_id].buy_now_url|default:""}" size="40">
                </div>
            </div>
        </fieldset>
    </div>
