...
{/capture}
{include file="common/mainbox.tpl" title=__("ab__category_banners") content=$smarty.capture.mainbox select_languages=true adv_buttons=$smarty.capture.adv_buttons buttons=$smarty.capture.buttons}
