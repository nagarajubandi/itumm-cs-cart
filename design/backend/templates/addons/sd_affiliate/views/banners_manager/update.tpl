...
{if $banner_type == "T"}
    {include file="addons/sd_affiliate/views/banners_manager/components/text_banner_update.tpl"}
{elseif $banner_type == "G"}
    {include file="addons/sd_affiliate/views/banners_manager/components/graphic_banner_update.tpl"}
{elseif $banner_type == "P"}
    {include file="addons/sd_affiliate/views/banners_manager/components/product_banner_update.tpl"}
{/if}
