...
<div class="controls">
{include file="common/colorpicker.tpl" cp_name="static_data[ab__ut_mwi__label_color]" cp_id="ab__ut_mwi__label_color_{$id}" cp_value=$static_data.ab__ut_mwi__label_color|default:"#ffffff"}
</div>
</div>
{** label background **}
<div class="control-group">
...
<div class="controls">
{include file="common/colorpicker.tpl" cp_name="static_data[ab__ut_mwi__label_background]" cp_id="ab__ut_mwi__label_background_{$id}" cp_value=$static_data.ab__ut_mwi__label_background|default:"#ff0000"}
</div>
</div>
</fieldset>
