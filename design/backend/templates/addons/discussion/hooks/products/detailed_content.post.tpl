...
{$divclass=""}{if ($runtime.company_id)} {$divclass="style=display:none"}{/if}
   {if !($runtime.company_id)} {include file="common/subheader.tpl" title=__("comments_and_reviews") target="#discussion_product_setting" }
    <div id="discussion_product_setting" class="in collapse" {$divclass}>
    	<fieldset>
			{$no_hide_input = false}
