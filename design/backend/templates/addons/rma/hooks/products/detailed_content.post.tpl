...
<div class="control-group">
    ...
    <div class="controls">
        <input type="text" id="return_period" name="product_data[return_period]" value="{$product_data.return_period|default:"30"}" size="10"  {if $product_data.is_returnable != "Y" && $runtime.mode != "add"}disabled="disabled"{/if} />
    </div>
</div>
</div>
{/if}