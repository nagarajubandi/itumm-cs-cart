<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 17:09:32
         compiled from "/var/www/html/itumm.com/design/themes/responsive/templates/views/checkout/components/steps/step_two.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12354501055b33777492a682-20593849%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cc42194722b6a46d25eeedbb1553baf6086f3211' => 
    array (
      0 => '/var/www/html/itumm.com/design/themes/responsive/templates/views/checkout/components/steps/step_two.tpl',
      1 => 1525408251,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12354501055b33777492a682-20593849',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337774998256_03761284',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337774998256_03761284')) {function content_5b337774998256_03761284($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/block.hook.php';
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['number_of_step']->value, ENT_QUOTES, 'ISO-8859-1');
        ...
        <?php if ($_smarty_tpl->tpl_vars['complete']->value&&!$_smarty_tpl->tpl_vars['edit']->value) {?>
            <a class="ty-step__title-txt cm-ajax" href="<?php echo htmlspecialchars(fn_url("checkout.checkout?edit_step=step_two&from_step=".((string)$_smarty_tpl->tpl_vars['cart']->value['edit_step'])), ENT_QUOTES, 'ISO-8859-1');?>
...
if (!$_smarty_tpl->tpl_vars['edit']->value) {?> hidden<?php }?> cm-skip-save-fields">
 ...
 cm-ajax-full-render <?php if ($_smarty_tpl->tpl_vars['final_step']->value=="step_two") {?>cm-checkout-recalculate-form<?php }?>" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" method="<?php if (!$_smarty_tpl->tpl_vars['edit']->value) {?>get<?php } else { ?>post<?php }?>">
            <input type="hidden" name="update_step" value="step_two" />
            <input type="hidden" name="next_step" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['next_step']->value, ENT_QUOTES, 'ISO-8859-1');?>
" />
