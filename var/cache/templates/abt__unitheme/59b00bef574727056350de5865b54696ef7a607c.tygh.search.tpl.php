<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 17:33:38
         compiled from "/var/www/html/itumm.com/design/themes/responsive/templates/views/orders/search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17568378655b337d1a1831b9-16158728%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '59b00bef574727056350de5865b54696ef7a607c' => 
    array (
      0 => '/var/www/html/itumm.com/design/themes/responsive/templates/views/orders/search.tpl',
      1 => 1525439740,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '17568378655b337d1a1831b9-16158728',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337d1a1e8e09_54734309',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337d1a1e8e09_54734309')) {function content_5b337d1a1e8e09_54734309($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/block.hook.php';
...
<?php echo $_smarty_tpl->getSubTemplate ("common/section.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('section_title'=>$_smarty_tpl->__("search_options"),'section_content'=>Smarty::$_smarty_vars['capture']['section'],'class'=>"ty-search-form",'collapse'=>false), 0);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['email'], ENT_QUOTES, 'ISO-8859-1');?>
            ...
            <td class="ty-orders-search__item"><?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['o']->value['timestamp'],((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'ISO-8859-1');?>
</td>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:manage_data"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
            ...
            <td class="ty-orders-search__item"><a class="ty-btn__primary ty-btn" href="<?php echo htmlspecialchars(fn_url("orders.details?order_id=".((string)$_smarty_tpl->tpl_vars['o']->value['order_id'])), ENT_QUOTES, 'ISO-8859-1');?>
">View / Modify Order</a></td>
        </tr>
    <?php }
