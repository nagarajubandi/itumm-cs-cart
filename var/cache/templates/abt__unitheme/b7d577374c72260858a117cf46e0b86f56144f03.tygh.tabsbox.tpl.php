<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 16:47:21
         compiled from "/var/www/html/itumm.com/design/themes/abt__unitheme/templates/common/tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6416269585b337241dd4ae5-21279205%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b7d577374c72260858a117cf46e0b86f56144f03' => 
    array (
      0 => '/var/www/html/itumm.com/design/themes/abt__unitheme/templates/common/tabsbox.tpl',
      1 => 1525364906,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6416269585b337241dd4ae5-21279205',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337241e33422_31020147',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337241e33422_31020147')) {function content_5b337241e33422_31020147($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_empty_tabs')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/modifier.empty_tabs.php';
...
?>
        <?php if ($_smarty_tpl->tpl_vars['navigation']->value['ab__grid_tab']=='Y') {?>
            <?php if (((!$_smarty_tpl->tpl_vars['tabs_section']->value&&!$_smarty_tpl->tpl_vars['tab']->value['section'])||($_smarty_tpl->tpl_vars['tabs_section']->value==$_smarty_tpl->tpl_vars['tab']->value['section']))&&!smarty_modifier_in_array($_smarty_tpl->tpl_vars['key']->value,$_smarty_tpl->tpl_vars['empty_tab_ids']->value)&&substr($_smarty_tpl->tpl_vars['key']->value,0,12)=='ab__grid_tab') {?>
...
" <?php if ($_smarty_tpl->tpl_vars['tab']->value['ab__grid_tabs']) {?>data-url="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['tab']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
"<?php }?> class="<?php if ($_smarty_tpl->tpl_vars['tab']->value['ab__grid_tabs']) {?>ab__grid_tabs <?php }?>ty-tabs__item<?php if ($_smarty_tpl->tpl_vars['tab']->value['js']) {?> cm-js<?php } elseif ($_smarty_tpl->tpl_vars['tab']->value['ajax']) {?> cm-js cm-ajax<?php }
if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['active_tab']->value) {?> active<?php }?>"><a class="ty-tabs__a" <?php if (!$_smarty_tpl->tpl_vars['tab']->value['ab__grid_tabs']&&$_smarty_tpl->tpl_vars['tab']->value['href']) {?> href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['tab']->value['href']), ENT_QUOTES, 'ISO-8859-1');?>
