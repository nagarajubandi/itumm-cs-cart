<?php /* Smarty version Smarty-3.1.21, created on 2018-06-28 22:47:20
         compiled from "/var/www/html/itumm.com/design/backend/templates/views/orders/components/orders_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8785618065b337517d7f936-83623087%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0aa17dda355277ecec0cdee96d57957365ce9eb3' => 
    array (
      0 => '/var/www/html/itumm.com/design/backend/templates/views/orders/components/orders_search_form.tpl',
      1 => 1530206236,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8785618065b337517d7f936-83623087',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_5b337517de6e16_41193331',
  'variables' => 
  array (
    'in_popup' => 0,
    'form_meta' => 0,
...
<?php if ($_valid && !is_callable('content_5b337517de6e16_41193331')) {function content_5b337517de6e16_41193331($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_html_checkboxes')) include '/var/www/html/itumm.com/app/lib/vendor/smarty/smarty/libs/plugins/function.html_checkboxes.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['incompleted_view']->value) {?>
    <input type="hidden" name="status" value="<?php echo htmlspecialchars(@constant('STATUS_INCOMPLETED_ORDER'), ENT_QUOTES, 'ISO-8859-1');?>
" />
<?php } else { ?>
<div class="control-group">
...
<div class="group">
    <div class="control-group">
        <label class="checkbox" for="a_uid"><input type="checkbox" name="admin_user_id" id="a_uid" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['auth']->value['user_id'], ENT_QUOTES, 'ISO-8859-1');?>
