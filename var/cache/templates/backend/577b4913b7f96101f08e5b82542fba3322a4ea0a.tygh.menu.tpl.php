<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 16:47:25
         compiled from "/var/www/html/itumm.com/design/backend/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1933681045b337245efbac5-80739824%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '577b4913b7f96101f08e5b82542fba3322a4ea0a' => 
    array (
      0 => '/var/www/html/itumm.com/design/backend/templates/menu.tpl',
      1 => 1527839171,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1933681045b337245efbac5-80739824',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_5b33724605afc4_96255358',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b33724605afc4_96255358')) {function content_5b33724605afc4_96255358($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('all_vendors','view_storefront','storefront_url_not_defined','manage_stores','vendor','manage_stores','manage_vendors','signed_in_as','edit_profile','sign_out','feedback_values','send_feedback','search_tooltip'));
?>
...
...</a></li>
        ...
        <?php if (fn_allowed_for("MULTIVENDOR")&&!$_smarty_tpl->tpl_vars['runtime']->value['simple_ultimate']) {?>
            <ul class="nav">
                <li class="nav-company">
                    <a href="<?php echo htmlspecialchars(htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1', true), ENT_QUOTES, 'ISO-8859-1');?>
"  class="brand" >
					<?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']) {?>
					 <img src="https://itumm.com/images/logos/3/fav_icon__iTumm-02_-edited.png" alt="Smiley face" height="42" width="42"> 
					<?php } else { ?>
                        <i class="icon-shopping-cart icon-white"></i>
					<?php }?>
                    </a>
...
" class="brand" style="text-transform: none !important;"><?php echo htmlspecialchars("iTumm Sellerhub", ENT_QUOTES, 'ISO-8859-1');?>
</a>
					<?php } else { ?>
                      <a href="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'ISO-8859-1');?>
" class="brand" ><?php echo htmlspecialchars(smarty_modifier_truncate($_smarty_tpl->tpl_vars['settings']->value['Company']['company_name'],60,"...",true), ENT_QUOTES, 'ISO-8859-1');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['auth']->value['company_id']) {?>
                    <li class="dropdown" >
                        <a href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id'])), ENT_QUOTES, 'ISO-8859-1');?>
" style="text-transform: none !important;"> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['runtime']->value['company_data']['company'], ENT_QUOTES, 'ISO-8859-1');?>
</a>
                    </li>
                <?php } else { ?>
