<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 17:41:05
         compiled from "/var/www/html/itumm.com/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8803183425b337ed9721553-22639490%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b05b161ee23ad2f0bff7fd8794636ab3e7a07d80' => 
    array (
      0 => '/var/www/html/itumm.com/design/backend/templates/views/companies/update.tpl',
      1 => 1530100248,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8803183425b337ed9721553-22639490',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337ed9817a86_44508756',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337ed9817a86_44508756')) {function content_5b337ed9817a86_44508756($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/function.split.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_puny_decode')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/modifier.puny_decode.php';
...
"  />
    ...
    <div class="control-group">
        <label class="control-label cm-required" for="elm_company_pan_no">PAN No:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[pan_no]" id="elm_company_pan_no" size="10" maxlength="10" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['pan_no'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>

    <div class="control-group">
        <label class="control-label cm-required" for="elm_company_gst_reg_no">GST Registration No:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[gst_reg_no]" id="elm_company_gst_reg_no" size="15" maxlength="15" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['gst_reg_no'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_account_no">Bank Account No:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_account_no]" id="elm_company_bank_account_no" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['bank_account_no'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_name">Bank Name:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_name]" id="elm_company_bank_name" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['bank_name'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_ifsc_code">IFSC Code:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_ifsc_code]" id="elm_company_bank_ifsc_code" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['bank_ifsc_code'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>
	   <div class="control-group">
        <label class="control-label cm-required" for="elm_company_bank_account_holder_name">Account Holder Name:</label>
        <div class="controls">
            <input type="text" class="input-large" name="company_data[bank_account_holder_name]" id="elm_company_bank_account_holder_name" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['bank_account_holder_name'], ENT_QUOTES, 'ISO-8859-1');?>
"  />
        </div>
    </div>
...
<?php echo '<script'; ?>
 type="text/javascript">
    $(document).ready(function(){
        $('#elm_company_pan_no').keypress(function (e) {
        ...
        $('#elm_company_gst_reg_no').keypress(function (e) {
            var regex = new RegExp("^[a-zA-Z0-9]+$");
            var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
            if (regex.test(str)) {
                return true;
