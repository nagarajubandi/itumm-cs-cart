<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 17:14:18
         compiled from "/var/www/html/itumm.com/design/backend/templates/views/products/components/products_update_qty_discounts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6259427075b3378929e4ed8-18619267%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '505d78c0f59ce9778d92c9ad2416a14456e16af8' => 
    array (
      0 => '/var/www/html/itumm.com/design/backend/templates/views/products/components/products_update_qty_discounts.tpl',
      1 => 1527166483,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6259427075b3378929e4ed8-18619267',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337892a2fbf7_11769091',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337892a2fbf7_11769091')) {function content_5b337892a2fbf7_11769091($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/itumm.com/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tooltip'=>$_smarty_tpl->__("qty_discount_type_tooltip")), 0);?>
        ...
        <?php if (!fn_allowed_for("ULTIMATE:FREE")) {?>
         <?php if (!($_smarty_tpl->tpl_vars['runtime']->value['company_id'])) {?>    <th width="25%"><?php echo $_smarty_tpl->__("usergroup");?>
</th> <?php }?>
        <?php }?>
        <th width="15%">&nbsp;</th>
    </tr>
...
" id="box_add_qty_discount">
 ...
 (%)</option>
        ...
        <?php if (!fn_allowed_for("ULTIMATE:FREE")) {?>
        <?php if (!($_smarty_tpl->tpl_vars['runtime']->value['company_id'])) {?><td width="25%">
