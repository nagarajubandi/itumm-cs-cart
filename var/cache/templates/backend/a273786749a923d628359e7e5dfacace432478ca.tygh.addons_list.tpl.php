<?php /* Smarty version Smarty-3.1.21, created on 2018-06-27 17:23:42
         compiled from "/var/www/html/itumm.com/design/backend/templates/views/addons/components/addons_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9630783985b337ac69454a4-47209394%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a273786749a923d628359e7e5dfacace432478ca' => 
    array (
      0 => '/var/www/html/itumm.com/design/backend/templates/views/addons/components/addons_list.tpl',
      1 => 1498580732,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '9630783985b337ac69454a4-47209394',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b337ac69a3154_03512451',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b337ac69a3154_03512451')) {function content_5b337ac69a3154_03512451($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/itumm.com/app/functions/smarty_plugins/modifier.date_format.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['addons_list']->value) {?>
    <table class="table table-addons cm-filter-table" data-ca-input-id="elm_addon" data-ca-clear-id="elm_addon_clear" data-ca-empty-id="elm_addon_no_items<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'ISO-8859-1');?>
">
...
" class="row-status<?php if (!$_smarty_tpl->tpl_vars['a']->value['snapshot_correct']) {?> cm-promo-popup<?php }?>"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</a>
                    <?php } else { ?>
...
installed"<?php }?>><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
                    ...
                    <?php }?>
                <?php } else { ?>
                    <span class="row-status block"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['a']->value['name'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['key']->value : $tmp), ENT_QUOTES, 'ISO-8859-1');?>
</span>
                <?php }?>
