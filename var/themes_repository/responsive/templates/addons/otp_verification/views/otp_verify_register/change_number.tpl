<form name="change_number_form" action="{""|fn_url}" method="post">
	...
	<div style="margin-top: 40px;margin-left: 20px;margin-bottom: 40px;" class="ty-product-block__button">         
		...
		{include file="buttons/button.tpl" but_name="dispatch[otp_verify_register.register]" but_text=__("save") but_role="submit" but_meta="ty-btn__primary ty-btn__big cm-form-dialog-closer ty-btn"}
	</div>
</form>