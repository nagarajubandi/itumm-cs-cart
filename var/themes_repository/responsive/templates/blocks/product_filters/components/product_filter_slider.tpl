            ...
            <ul class="ty-range-slider__wrapper">
                <li class="ty-range-slider__item" style="left: 0%;">
                    <span class="ty-range-slider__num">
                        ...
                        <span>&lrm;{$filter.prefix nofilter}</span><bdi><span>{$min}</span></bdi>{$filter.suffix nofilter}</span>
                        {else}
                        <span><bdi><span>{$min}</span></bdi>&lrm;{$filter.prefix nofilter}</span>{$filter.suffix nofilter}</span>
                        {/if}
                    </span>
                </li>
                <li class="ty-range-slider__item" style="left: 100%;">
                    <span class="ty-range-slider__num">
                        {if $language_direction != 'rtl'}
                        <span>&lrm;{$filter.prefix nofilter}</span><bdi><span>{$max}</span></bdi>{$filter.suffix nofilter}</span>
                        {else}
                        <span><bdi><span>{$max}</span></bdi>&lrm;{$filter.prefix nofilter}</span>{$filter.suffix nofilter}</span>
                        {/if}
                    </span>
                </li>
            </ul>
