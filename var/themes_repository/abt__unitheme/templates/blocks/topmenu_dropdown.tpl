                ...
                {if $item1.$childs}
                    ...
                    {* Only two levels. Vertical output *}
                        <div class="ty-menu__submenu">
                            <ul class="ty-menu__submenu-items ty-menu__submenu-items-simple {if $cat_image.pair_id}with-pic {/if} cm-responsive-menu-submenu">
                 ...
                 {else}
                        ...
                        <div class="ty-menu__submenu" id="{$unique_elm_id}">
                            {hook name="blocks:topmenu_dropdown_3levels_cols"}
                                <ul class="ty-menu__submenu-items cm-responsive-menu-submenu dropdown-column-item {$dropdown_class} {if $cat_image.pair_id}with-pic {/if} clearfix">
		                        ...
		                        {split data=$item1.$childs size=$rows assign="splitted_categories" skip_complete=true}
                                    ...
                                    {if !$cat_image.pair_id && $item1_url}
