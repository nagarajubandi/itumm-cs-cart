...
<fieldset data-form-name="servicenumber" data-step="1" class="current" id="otp_verify_div">
	...
	<div id="change_number_div">
		...
		<div style="margin-top: 40px;margin-left: 20px;margin-bottom: 40px;" class="ty-product-block__button">         
            ...
            {include file="buttons/button.tpl" but_name="dispatch[profiles.update]" but_text=__("verify") but_role="submit" but_meta="ty-btn__primary ty-btn__big cm-form-dialog-closer ty-btn" but_id="verify_button"}
		</div>
	</form>
	</div>
	<!-- otp_verify_div -->
